...
ActiveRecord::Schema.define(version: 20151105105129) do
  ...
  add_index "merchants", ["image_id"], name: "index_merchants_on_image_id"
  ...
  add_index "paths", ["image_id"], name: "index_paths_on_image_id"
  ...
  add_index "stages", ["image_id"], name: "index_stages_on_image_id"
  add_index "stages", ["merchant_id"], name: "index_stages_on_merchant_id"
  add_index "stages", ["path_id"], name: "index_stages_on_path_id"
