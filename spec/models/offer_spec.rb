...
describe Offer, type: :model do
  ...
  describe '#image_url' do
    let(:image) { create(:image, resource: File.open("#{Rails.root}/spec/fixtures/images/image1.jpg")) }
    ...
    it 'returns the full url of the first image' do
      ...
      expect(offer.image_url).to eq("http://127.0.0.1:3000/uploads/image/resource/#{image.id}/image1.jpg")
    end
  end
end
